...
//viewing about page data
$sql = "SELECT * FROM `about` WHERE about_del = '0' ORDER BY about_date DESC";
$result = $db->query($sql);
if ($db->error) {
  exit("SQL error");
}
...
//viewing blog page information
$sql = "SELECT * FROM `add_blog` WHERE add_blog_del = '0' ORDER BY add_blog_date DESC";
$result = $db->query($sql);
if($db->error){
  exit('SQL error!');
}
$add_blog_row = $result->fetch_assoc();
$add_blog_title = $add_blog_row['add_blog_title'];
$add_blog_author = $add_blog_row['add_blog_author'];
$add_blog_date = $add_blog_row['add_blog_date'];
$add_blog_img = str_replace('../', '',  $add_blog_row['add_blog_img']);
$add_blog_post =$add_blog_row['add_blog_post'];
  ...
  <header id="header">
    <div class="d-flex flex-column">
      <div class="profile">
        ...
        <h1 class="text-light"><a href="index.html">Md. Mahedi Hasan</a></h1>
  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong><?php echo $birthday; ?></li>
                  <li><i class="icofont-rounded-right"></i> <strong>Website:</strong> <?php echo $website; ?></li>
                  <li><i class="icofont-rounded-right"></i> <strong>Phone:</strong> <?php echo $phone; ?></li>
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="resume-item pb-0">
              <h4><?php echo $summary_name; ?></h4>
              <p><em><?php echo $summary_about; ?></em></p>
              <ul>
                <li><?php echo $summary_address; ?></li>
                <li><?php echo $summary_phone; ?></li>
                <li><?php echo $summary_email; ?></li>
              </ul>
            </div>
            <h3 class="resume-title">Education</h3>
            <div class="resume-item">
              <h4><?php echo $education_degree; ?></h4>
              <h5><?php echo $education_session; ?></h5>
              <p><em><?php echo $education_institute; ?></em></p>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="resume-item">
              ...
              <h5><?php echo $years; ?></h5>
              <p><em><?php echo $company_name; ?></em></p>
              <ul>
    ...
    <section id="blogs" class="blogs section-bg">
      ...
      <div class="container">
        ...
        <!-- Title -->
        <h1 class="mt-4"><?php echo $add_blog_title; ?></h1>
        <!-- Author -->
        <p class="lead">
          by
          <a href="#"><?php echo $add_blog_author; ?></a>
        </p>
        <hr>
        <!-- Date/Time -->
        <p>Posted on <?php echo $add_blog_date; ?></p>
        <hr>
        <!-- Preview Image -->
        <img class="" src="<?php echo $add_blog_img; ?>" alt="No image found!" width="900" height="300">
        <hr>
        <!-- Post Content -->
        <p><?php echo $add_blog_post; ?></p>
        <hr>
        <!-- Comments Form -->
        <div class="card my-4">
