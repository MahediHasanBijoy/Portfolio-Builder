  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseFacts" class="collapse show" aria-labelledby="headingFacts" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="addfacts.php">Add Facts</a>
            <a class="collapse-item active" href="editfacts.php"> Edit  Facts</a>
          </div>
        </div>
      </li>
        ...
        <div class="container-fluid">
          ...
          <form>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="happyclients" placeholder="Enter number of happy clients">
            </div>
            <div class="form-group">
              <label for="projects">Projects</label>
              <input type="text" class="form-control" id="projects" placeholder="Enter number of projects">
            </div>
            <div class="form-group">
              <label for="hoursofsupport">Hours of Support</label>
              <input type="number" class="form-control" id="hoursofsupport" placeholder="Enter hours of support">
            </div>
            <div class="form-group">
              <label for="hardworkers">Hard Workers</label>
              <input type="text" class="form-control" id="hardworkers" placeholder="Enter number of hard workers">
            </div>
