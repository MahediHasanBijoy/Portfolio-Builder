    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseResume" class="collapse show" aria-labelledby="headingResume" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="addresume.php">Add Resume</a>
                  ...
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-summary" role="tabpanel" aria-labelledby="nav-summary-tab">
                      ...
                      <form action="#" method="post">
                        ...
                        <button name="save_summary" type="submit" class="btn btn-primary">Submit</button>
                      </form>
                    ...
                    <div class="tab-pane fade" id="nav-education" role="tabpanel" aria-labelledby="nav-education-tab">
                      <form action="#" method="post">
                        <div class="form-group">
                          ...
                          <input name="degree" type="text" class="form-control" id="degree" placeholder="Enter your degree">
                        </div>
                        <div class="form-group">
                          <label for="session">Session</label>
                          <input name="session" type="text" class="form-control" id="session" placeholder="Enter your session">
                        </div>
                        <div class="form-group">
                          <label for="institutename">InstituteName</label>
                          <input name="institutename" type="text" class="form-control" id="institutename" placeholder="Enter your institute">
                        </div>
                        <div class="form-group">
                          <label for="description" >Description</label>
                          <textarea name="description" class="form-control" id="description"></textarea>
                        </div>
                        <button name="save_education" type="submit" class="btn btn-primary">Submit</button>
                      </form>
                    </div>
                    ...
                    <div class="tab-pane fade" id="nav-professional-experience" role="tabpanel" aria-labelledby="nav-professional-experience-tab">
                      <form action="#" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <input name="years" type="text" class="form-control" id="years" placeholder="Enter your working years">
                        </div>
                        <div class="form-group">
                          <label for="companyname">CompanyName</label>
                          <input name="companyname" type="text" class="form-control" id="companyname" placeholder="Enter the company name">
                        </div>
                        <div class="form-group">
                          <label for="description" >Description</label>
                          <textarea name="description" class="form-control" id="description"></textarea>
                        </div>
                        <button name="save_professional_experience" type="submit" class="btn btn-primary">Submit</button>
                      </form>
                    </div>
