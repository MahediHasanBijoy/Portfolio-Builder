...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <form action="#" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input name="blog_title" type="text" class="form-control" id="blog_title" placeholder="Enter the title of blog">
            </div>
            <div class="form-group">
              <label for="author">Author</label>
              <input name="author" type="text" class="form-control" id="author" placeholder="Enter name of the author">
            </div>
            <div class="form-group">
              <label for="upload_image">Upload Image</label>
              <input type="hidden" name="MAX_FILE_SIZE" value="30000000">
              <input type="file" name="upload_image" class="form-control" id="upload_image" placeholder="">
            </div>
          ...
          <?php endif; ?>
            <div class="form-group">
              ...
              <textarea name="blog_post" class="form-control" id="blog_post"></textarea>
            </div>

            <button name="add_blog_save" type="submit" class="btn btn-primary">Save</button>
          </form>
          <!-- /end of input form -->
        </div>
        <!-- /.container-fluid -->
  ...
  <script> CKEDITOR.replace('blog_post'); </script>
