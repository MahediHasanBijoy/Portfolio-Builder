      ...
      <li class="nav-item active">
        ...
        <div id="collapseAbout" class="collapse show" aria-labelledby="headingAbout" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="editabout.php">Edit  About</a>
          </div>
        </div>
      </li>
        ...
        <div class="container-fluid">
          ...
          <form>
            <div class="form-group">
              ...
              <textarea class="form-control" id="aboutyou"></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="birthday" placeholder="Enter your Birth Date">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="website" placeholder="Enter your website address">
            </div>
            <div class="form-group">
