  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item ">
        ...
        <div id="collapseAbout" class="collapse show" aria-labelledby="headingAbout" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="addabout.php">Add About</a>
        ...
        <div class="container-fluid">
          ...
          <form action="#" method="post">
            <div class="form-group">
              ...
              <textarea name="about_you" class="form-control" id="aboutyou"></textarea>
            </div>
            <div class="form-group">
              <label for="profession">Profession</label>
              <input name="profession" type="text" class="form-control" id="profession" placeholder="Enter your profession">
            </div>
            <div class="form-group">
              <label for="birthday">Birthday</label>
              <input name="birthday" type="text" class="form-control" id="birthday" placeholder="Enter your Birth Date">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input name="website" type="text" class="form-control" id="website" placeholder="Enter your website address">
            </div>
            <div class="form-group">
            ...
            <button type="submit" name="add_about_btn" class="btn btn-primary">Submit</button>
          </form>
          <!-- /end of input form -->
        </div>
        <!-- /.container-fluid -->
