          ...
          <li class="nav-item active">
            ...
            <div id="collapseBlogs" class="collapse show" aria-labelledby="headingBlogs" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item active" href="editblog.php">Edit Blog</a>
              </div>
            </div>
          </li>
          <!-- Nav Item - Charts -->
                ...
                <div class="container-fluid">
                  <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <?php
                      $i=1;
                      while($add_blog_row = $result->fetch_assoc()){

                      $serial = $i;
                      $i++;
                      $add_blog_id = $add_blog_row['add_blog_id'];
                      ...
                      if (strlen($add_blog_post)>35) {
                        $maxlength = 34;
                        $add_blog_post = substr($add_blog_post, 0, $maxlength).".....";
                      }

                      ?>
                      <tr>
                        <td><?php echo $serial; ?></td>
                        <td><?php echo $add_blog_title; ?></td>
                        <td><?php echo $add_blog_post; ?></td>
                        <td><?php echo $add_blog_author; ?></td>
                        <td><?php echo $add_blog_date; ?></td>
                        <td><a href="edit_blog_post.php?edit-blog=<?php echo $add_blog_id; ?>" class=""><b>Edit</b> </a></td>
                        <td><a href="index.php?delete_todo=<?php echo $t_id; ?>" class=""><b>Delete</b></a></td>
                      </tr>
                      <?php 
                        }
                        //Free result set
