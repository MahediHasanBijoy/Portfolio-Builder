...
//viewing blog post for editing
$sql = "SELECT * FROM `add_blog` WHERE add_blog_id = '$edit_blog_id'";
$result = $db->query($sql);
if($db->error){
  exit('SQL error!');
}else{
$edit_blog_row    = $result->fetch_assoc();
$edit_blog_title  = $edit_blog_row['add_blog_title'];
$edit_blog_author = $edit_blog_row['add_blog_author'];
$edit_blog_date   = $edit_blog_row['add_blog_date'];
$edit_blog_img    = $edit_blog_row['add_blog_img'];
$edit_blog_post   = $edit_blog_row['add_blog_post'];
}
 ?>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseBlogs" class="collapse show" aria-labelledby="headingBlogs" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="addblog.php">Add Blog</a>
        ...
        <div class="container-fluid">
          ...
          <form action="#" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input name="edit_blog_title" type="text" class="form-control" id="edit_blog_title" placeholder="Enter the title of blog" value="<?php echo $edit_blog_title; ?>">
            </div>
            <div class="form-group">
              <label for="edit_author">Author</label>
              <input name="edit_author" type="text" class="form-control" id="edit_author" placeholder="Enter name of the author" value="<?php echo $edit_blog_author; ?>">
            </div>
            <div class="form-group">
              
              <label for="upload_image">Upload Image</label>
              <img src="<?php echo $edit_blog_img; ?>" alt="" height="50px" width="100px">
              <input type="hidden" name="MAX_FILE_SIZE" value="30000000">
              <input type="file" name="edit_upload_image" class="form-control" id="edit_upload_image" placeholder="">
            </div>
            <?php if (isset($errors['upload_image'])): ?>
            <div class="alert alert-danger">
              <li><?php echo $errors['upload_image']; ?></li>
            </div>
          <?php endif; ?>
            <div class="form-group">
              <label for="edit_blog_post" >Blog Post</label>
              <textarea name="edit_blog_post" class="form-control" id="edit_blog_post" ><?php echo $edit_blog_post; ?></textarea>
            </div>

            <button name="edit_blog_update" type="submit" class="btn btn-primary">Update</button>
          </form>
          <!-- /end of input form -->
        </div>
        <!-- /.container-fluid -->
  ...
  <script> CKEDITOR.replace('edit_blog_post'); </script>
